...
const ManageCognitiveAssessment = () => {
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: { sm: '100%', md: '1700px' } }}>
      ...
      <Box sx={{display:'flex', justifyContent:'center', alignItems:'center', width:'100%', mt:'2.3rem'}}>
        <Button variant='contained' onClick={()=>navigate("/studentScoreEntry")}> Manage Students' Scores</Button>
      </Box>
    </Box>
  )
}

export default ManageCognitiveAssessment